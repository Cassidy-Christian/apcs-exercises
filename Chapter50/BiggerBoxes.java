...
public class BiggerBoxes
{
  ...
  public BiggerBoxes (double side){
   this.length= side;
   this.width=side; 
   this.height=side; 
   //return new Box(side,side,side);
    ...
    public BiggerBoxes(BiggerBoxes oldbox){
    this.length=oldbox.getLength(); 
    this.width=oldbox.getWidth(); 
    this.height=oldbox.getHeight(); 
    }
 public BiggerBoxes biggerBox(BiggerBoxes oldbox){
      return new BiggerBoxes(1.25*oldbox.getWidth(), 1.25*oldbox.getHeight(), 1.25*oldbox.getLength()); 
  }
  public BiggerBoxes( double width, double height, double length) 
  {
    this.length = length;
    this.height = height;
    this.width = width; 
...
public boolean nests( BiggerBoxes outsideBox ){
